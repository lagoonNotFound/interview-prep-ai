...
import AuthModel from "./AuthModel" // agar ye component bana hai
                    ...
                    <div className='flex items-center gap-6 relative'>
                        ...
                        <div className='relative'>
                            <button
                                ...
                                className='flex items-center gap-2 px-4 py-2 rounded-full text-md hover:bg-gray-200 transition'
                            >
                                <BsCoin size={20} />
                                {userData?.credits || 0}
                            </button>
